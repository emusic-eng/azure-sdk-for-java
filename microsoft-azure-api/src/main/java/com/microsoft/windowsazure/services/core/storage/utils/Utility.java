...
public final class Utility {
    ...
    /**
     * Returns extended error information from the specified request.
     * 
     * @param request
    ...
    public static String safeEncode(final String stringToEncode) throws StorageException {
        ...
        try {
            final String tString = URLEncoder.encode(stringToEncode, "UTF-8");
     ...
     *            <code>true</code> if an MD5 hash will be calculated; otherwise, <code>false</code>.
     * @param currentResult
     *            A {@link RequestResult} object that represents the result for the current request.
     * @param opContext
     *            An {@link OperationContext} object that represents the context for the current operation. This object
     *            is used to track requests to the storage service, and to provide additional runtime information about
     *            the operation.

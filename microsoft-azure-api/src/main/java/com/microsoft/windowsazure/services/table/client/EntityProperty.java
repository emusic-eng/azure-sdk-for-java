...
/**
 * A class which represents a single typed property value in a table entity. An
 * {@link EntityProperty} stores the data type as an {@link EdmType}. The value,
 * which may be <code>null</code> for object types, but not for primitive types,
 * is serialized and stored as a <code>String</code>.
 * <p>
 * {@link EntityProperty} provides overloaded constructors and overloads of the
 * <code>setValue</code> method for supported value types. Each overloaded
 * constructor or <code>setValue</code> method sets the {@link EdmType} and
 * serializes the value appropriately based on the parameter type.
 * <p>
 * Use one of the <code>getValueAs</code><em>Type</em> methods to deserialize an
 * {@link EntityProperty} as the appropriate Java type. The method will throw a
 * {@link ParseException} or {@link IllegalArgumentException} if the
...
public final class EntityProperty
{
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a <code>boolean</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a <code>Date</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a <code>Date</code>
     * value WITHOUT changing date using local timezone!!
     * 
     * @param value
     *            The <code>Date</code> to set as the entity property value.
     */
    public EntityProperty(final Date value, boolean useTimeZone)
    {
	this.setValue(value, useTimeZone);

    }

    /**
     * Constructs an {@link EntityProperty} instance from a <code>double</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Constructs an {@link EntityProperty} instance from an <code>int</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a <code>long</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a <code>String</code>
     * value.
     * 
     * @param value
    ...
    /**
     * Reserved for internal use. Constructs an {@link EntityProperty} instance
     * from a <code>String</code> value and a data type, and verifies that the
     * value can be interpreted as the specified data type.
     * 
     * @param value
     *            The <code>String</code> representation of the value to
     *            construct.
     * @param edmType
     *            The {@link EdmType} data type of the value to construct.
     * @throws ParseException
     *             if the <code>String</code> representation of the value cannot
     *             be interpreted as the data type.
     */
    ...
    /**
     * Constructs an {@link EntityProperty} instance from a
     * <code>java.util.UUID</code> value.
     * 
     * @param value
     *            The <code>java.util.UUID</code> to set as the entity property
     *            value.
     */
    ...
    /**
     * Reserved for internal use. Constructs an {@link EntityProperty} instance
     * as a <code>null</code> value with the specified type.
     * 
     * @param type
     ...
     * .
     * 
     * @return The {@link EdmType} enumeration value for the data type of the
     *         {@link EntityProperty}.
     */
    ...
    /**
     * Gets a flag indicating that the {@link EntityProperty} value is
     * <code>null</code>.
     * 
     * @return A <code>boolean</code> flag indicating that the
     *         {@link EntityProperty} value is <code>null</code>.
     */
     ...
     *         {@link EntityProperty} value.
     * 
     * @throws IllegalArgumentException
     *             if the value is <code>null</code> or cannot be parsed as a
     *             <code>boolean</code>.
     */
    ...
    /**
     * Gets the value of this {@link EntityProperty} as a <code>byte</code>
     * array.
     * 
     * @return A <code>byte[]</code> representation of the
     *         {@link EntityProperty} value, or <code>null</code>.
     */
     ...
     * 
     * @return A <code>Date</code> representation of the {@link EntityProperty}
     *         value, or <code>null</code>.
     * 
     * @throws IllegalArgumentException
     *             if the value is not <code>null</code> and cannot be parsed as
     *             a <code>Date</code>.
     */
     ...
     * 
     * @return An <code>int</code> representation of the {@link EntityProperty}
     *         value.
     * 
     * @throws IllegalArgumentException
     *             if the value is <code>null</code> or cannot be parsed as an
     *             <code>int</code>.
     */
     ...
     * 
     * @return A <code>long</code> representation of the {@link EntityProperty}
     *         value.
     * 
     * @throws IllegalArgumentException
     *             if the value is <code>null</code> or cannot be parsed as a
    ...
    /**
     * Gets the value of this {@link EntityProperty} as a
     * <code>java.util.UUID</code>.
     * 
     * @return A <code>java.util.UUID</code> representation of the
     *         {@link EntityProperty} value, or <code>null</code>.
     * 
     * @throws IllegalArgumentException
     *             if the value cannot be parsed as a
     *             <code>java.util.UUID</code>.
     */
    ...
    /**
     * Sets this {@link EntityProperty} using the serialized
     * <code>boolean</code> value.
     * 
     * @param value
     *            The <code>boolean</code> value to set as the
     *            {@link EntityProperty} value.
     */
    ...
    /**
     * Sets this {@link EntityProperty} using the serialized <code>byte[]</code>
     * value.
     * 
     * @param value
     *            The <code>byte[]</code> value to set as the
     *            {@link EntityProperty} value. This value may be
     *            <code>null</code>.
     */
    ...
    /**
     * Sets this {@link EntityProperty} using the serialized <code>Date</code>
     * value.
     * 
     * @param value
     *            The <code>Date</code> value to set as the
     *            {@link EntityProperty} value. This value may be
     *            <code>null</code>.
     */
     ...
     * 
     * @param useTimeZone
     *            Indicates whether or not to apply the current timeZone when
     *            saving value to set as the {@link EntityProperty} value.
     */
    public synchronized final void setValue(final Date value, boolean useTimeZone)
    {
	...
	{
	    SimpleDateFormat f = new SimpleDateFormat(Utility.ISO8061_LONG_PATTERN);
	    this.value = f.format(value);
	}
    }

    /**
     * Sets this {@link EntityProperty} using the serialized <code>double</code>
     * value.
     * 
     * @param value
     *            The <code>double</code> value to set as the
     *            {@link EntityProperty} value.
     */
    ...
    /**
     * Sets this {@link EntityProperty} using the serialized <code>int</code>
     * value.
     * 
     * @param value
     *            The <code>int</code> value to set as the
     *            {@link EntityProperty} value.
     */
    ...
    /**
     * Sets this {@link EntityProperty} using the serialized <code>long</code>
     * value.
     * 
     * @param value
     *            The <code>long</code> value to set as the
     *            {@link EntityProperty} value.
     */
     ...
     * 
     * @param value
     *            The <code>String</code> value to set as the
     *            {@link EntityProperty} value. This value may be
     *            <code>null</code>.
     */
     ...
     * 
     * @param value
     *            The <code>java.util.UUID</code> value to set as the
     *            {@link EntityProperty} value. This value may be
     *            <code>null</code>.
     */
    ...
    /**
     * Reserved for internal use. Sets the null value flag to the specified
     * <code>boolean</code> value.
     * 
     * @param isNull
